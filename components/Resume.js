              ...
              <div className="row justify-content-between">
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-3s">
                    ...
                    <div className="content">
                      <span className="years">March, 2024</span>
                ...
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-4s">
                    ...
                    <div className="content">
                      <span className="years">February, 2024</span>
                      <h4>Motion Poster</h4>
                      <span className="company">DJ Gauti</span>
                    </div>
                  </div>
                </div>
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-4s">
                    ...
                    <div className="content">
                      <span className="years">January, 2024</span>
                      <h4>Video Editor</h4>
                      <span className="company">The Nex You, Inc.</span>
                    </div>
                  </div>
                </div>
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-4s">
                    ...
                    <div className="content">
                      <span className="years">December, 2023</span>
                      <h4>Video Editor</h4>
                      <span className="company">Future Automobiles, Inc.</span>
                    </div>
                  </div>
                </div>
              </div>
