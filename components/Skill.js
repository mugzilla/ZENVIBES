...
const items = [
  {
    id: 1,
    name: "Illustrator",
    image: "assets/images/skills/ai.png",
    value: "60",
  },
  {
    id: 2,
    name: "Photoshop",
    image: "assets/images/skills/ps.png",
    value: "80",
  },
  {
    id: 3,
  ...
  },
  {
    id: 6,
    name: "Premeire Pro",
    image: "assets/images/skills/pr.png",
    value: "75",
  },
  {
    id: 7,
            ...
            <div className="col-lg-5">
              <div className="skill-content-part rel z-2 rmb-55 wow fadeInUp delay-0-2s">
                <div className="section-title mb-40">
                  ...
                  <p>
                    Visuals that convert, websites that wow, & SEO that soars: I
                    craft impactful designs, captivating videos & build websites
                    that get results!
                  </p>
                </div>
